...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier { self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]; if (self) {
    ...
    for (UIView *view in @[self.mediaImageView, self.usernameAndCaptionLabel, self.commentLabel]) { [self.contentView addSubview:view]; } } return self;
}
...
+ (CGFloat) heightForMediaItem:(BLCMedia *)mediaItem width:(CGFloat)width {
    ...
    // The height will be wherever the bottom of the comments label is return
